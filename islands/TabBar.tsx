...
export default function TabBar(props: TabBarProps) {
  return (
    <nav class="tab-bar">
      <div
        class={`tab-bar__item ${
          props.index.value === 0 ? "tab-bar__item--active" : ""
        }`}
        onClick={() => props.index.value = 0}
      >
        <svg
          version="1.1"
          width="30"
          height="30"
          viewBox="0 0 48 48.00004"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
        >
          <g>
            <path d="M24.94067,13.43801c-0.51855-0.51953-1.36328-0.51953-1.88184,0l-9.125,9.125     c-0.37646,0.37695-0.58398,0.87793-0.58398,1.41016v9.64844c0,0.7334,0.59717,1.33008,1.33057,1.33008h7.23926     c0.19336,0,0.3501-0.15625,0.3501-0.34961v-4.92285c0-0.22559,0.0415-0.43848,0.12646-0.64258     c0.25684-0.66016,0.88623-1.08789,1.60352-1.08789c0.46924,0,0.90234,0.17969,1.22266,0.50781     c0.16895,0.16992,0.30078,0.36914,0.38477,0.58789c0.08154,0.19531,0.12256,0.4082,0.12256,0.63477v4.92285     c0,0.19336,0.15674,0.34961,0.3501,0.34961h7.23926c0.73389,0,1.33105-0.59668,1.33105-1.33008v-9.64844     c0-0.5332-0.20752-1.0332-0.58447-1.41016L24.94067,13.43801z M15.00708,31.75539v-0.88867     c0-0.19336,0.15674-0.34961,0.3501-0.34961s0.3501,0.15625,0.3501,0.34961v0.88867c0,0.19336-0.15674,0.34961-0.3501,0.34961     S15.00708,31.94875,15.00708,31.75539z M15.70727,29.20754c0,0.19336-0.15674,0.34961-0.3501,0.34961     s-0.3501-0.15625-0.3501-0.34961v-3.70117c0-0.19336,0.15674-0.34961,0.3501-0.34961s0.3501,0.15625,0.3501,0.34961V29.20754z" />
          </g>
        </svg>
        <span>Home</span>
      </div>
      ...
      <div
        class={`tab-bar__item ${
          props.index.value === 1 ? "tab-bar__item--active" : ""
        }`}
        onClick={() => props.index.value = 1}
      >
        <svg
          version="1.1"
          width="30"
